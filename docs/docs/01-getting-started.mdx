...
React Native Header only supports the [New Architecture](https://reactnative.dev/architecture/landing-page) beginning from version `1.0.0`. The legacy architecture will not be supported in the future as it has been deprecated.
