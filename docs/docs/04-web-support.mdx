...
For web applications using FlashList, you are required to use a version of FlashList that is verified for web compatibility. Please check the FlashList documentation
or test it separately on web to confirm you have a compatible version.
